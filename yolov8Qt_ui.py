...
################################################################################
## Form generated from reading UI file 'yolov8Qt.ui'
##
...
"")
        ...
        self.gridLayoutWidget_7.setGeometry(QRect(310, 740, 881, 51))
...
"}")
        ...
        self.frame_left_box.setGeometry(QRect(0, 80, 301, 701))
        self.frame_left_box.setStyleSheet(u"QFrame#frame_left_box{\n"
"background:#F1F6FF;\n"
"border: 1px solid #F1F6FF;\n"
"border-radius:8px;}")
        self.frame_left_box.setFrameShape(QFrame.StyledPanel)
        self.frame_left_box.setFrameShadow(QFrame.Raised)
        ...
        self.frame_is_save_box.setGeometry(QRect(10, 450, 281, 61))
        self.frame_is_save_box.setStyleSheet(u"QFrame#frame_is_save_box{\n"
"background:#6BABFA;}")
        self.frame_is_save_box.setFrameShape(QFrame.StyledPanel)
        self.frame_is_save_box.setFrameShadow(QFrame.Raised)
        ...
        self.frame_4 = QFrame(self.frame_left_box)
        self.frame_4.setObjectName(u"frame_4")
        self.frame_4.setGeometry(QRect(10, 520, 282, 171))
        self.frame_4.setStyleSheet(u"border:2px solid white;")
        self.frame_4.setFrameShape(QFrame.StyledPanel)
        self.frame_4.setFrameShadow(QFrame.Raised)
        self.label_left_bottom = QLabel(self.frame_4)
        self.label_left_bottom.setObjectName(u"label_left_bottom")
        self.label_left_bottom.setGeometry(QRect(0, 0, 281, 171))
        self.label_left_bottom.setPixmap(QPixmap(u"icon/v8left.png"))
        self.label_left_bottom.setScaledContents(True)
...
"background:white;\n"
"border-radius:8px;}")
        self.frame_weights_box.setFrameShape(QFrame.StyledPanel)
        self.frame_weights_box.setFrameShadow(QFrame.Raised)
...
"\n"
"")
        self.line_weights.setEchoMode(QLineEdit.Normal)
        self.line_weights.setCursorMoveStyle(Qt.LogicalMoveStyle)
...
"\n"
"border-radius:8px;}")
        self.frame_source_box.setFrameShape(QFrame.StyledPanel)
        self.frame_source_box.setFrameShadow(QFrame.Raised)
...
"border:none;")
        ...
        icon6 = QIcon()
        icon6.addFile(u"icon/\u56fe\u5c42_layers.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.Button_select_folder.setIcon(icon6)
...
"background:white;\n"
"border-radius:8px;}")
        self.frame_conf_box.setFrameShape(QFrame.StyledPanel)
        self.frame_conf_box.setFrameShadow(QFrame.Raised)
...
"background:white;\n"
"border-radius:8px;}")
        self.frame_iou_box.setFrameShape(QFrame.StyledPanel)
        self.frame_iou_box.setFrameShadow(QFrame.Raised)
...
"")
        ...
        self.frame_raw_box.setGeometry(QRect(1200, 80, 291, 161))
        ...
        self.frame_raw_box.setContextMenuPolicy(Qt.ActionsContextMenu)
        self.frame_raw_box.setLayoutDirection(Qt.LeftToRight)
...
"border:2px solid #6BABFA;}")
        self.frame_raw_box.setFrameShape(QFrame.StyledPanel)
        self.frame_raw_box.setFrameShadow(QFrame.Raised)
        self.label_raw = QLabel(self.frame_raw_box)
        self.label_raw.setObjectName(u"label_raw")
        self.label_raw.setGeometry(QRect(10, 10, 271, 141))
        self.label_raw.setLayoutDirection(Qt.LeftToRight)
        ...
        self.frame_result_box.setGeometry(QRect(300, 80, 881, 651))
        self.frame_result_box.setStyleSheet(u"QFrame#frame_result_box{\n"
"border:2px solid #6BABFA;\n"
"}")
        self.frame_result_box.setFrameShape(QFrame.StyledPanel)
        self.frame_result_box.setFrameShadow(QFrame.Raised)
        self.label_result = QLabel(self.frame_result_box)
        self.label_result.setObjectName(u"label_result")
        self.label_result.setGeometry(QRect(8, 8, 871, 641))
        self.label_result.setStyleSheet(u"")
        self.label_result.setPixmap(QPixmap(u"icon/background.jpg"))
        ...
        self.frame_result_box_2.setGeometry(QRect(1200, 250, 291, 541))
...
"border-bottom-left-radius: 0;\n"
"border-bottom-right-radius: 0px;}")
        self.frame_result_box_2.setFrameShape(QFrame.StyledPanel)
        self.frame_result_box_2.setFrameShadow(QFrame.Raised)
        self.frame_12 = QFrame(self.frame_result_box_2)
        self.frame_12.setObjectName(u"frame_12")
        self.frame_12.setGeometry(QRect(0, 0, 291, 41))
...
"padding-left:5px;")
        ...
        self.label_speed_3.setLayoutDirection(Qt.LeftToRight)
...
"padding-left:5px;")
        ...
        self.frame_2.setGeometry(QRect(10, 120, 271, 51))
        self.frame_2.setFrameShape(QFrame.StyledPanel)
        self.frame_2.setFrameShadow(QFrame.Raised)
        self.label_speed = QLabel(self.frame_2)
        self.label_speed.setObjectName(u"label_speed")
        self.label_speed.setGeometry(QRect(170, 0, 101, 51))
        self.label_speed.setFont(font6)
...
"color:black;")
        ...
        self.label_speed_4.setLayoutDirection(Qt.LeftToRight)
...
"padding-left:5px;")
        ...
        self.result_info.setGeometry(QRect(5, 180, 281, 351))
        font8 = QFont()
        font8.setFamilies([u"\u963f\u91cc\u5df4\u5df4\u666e\u60e0\u4f53"])
        font8.setPointSize(12)
        self.result_info.setFont(font8)
...
"border-radius:5px")
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"yolov8\u76ee\u6807\u68c0\u6d4b\u4e95\u76d6\u8bc6\u522b\u7cfb\u7edf", None))
        ...
        self.label_title.setText(QCoreApplication.translate("MainWindow", u"\u4e95\u76d6\u76ee\u6807\u68c0\u6d4b\u7cfb\u7edf", None))
#if QT_CONFIG(tooltip)
        ...
        self.label_left_bottom.setText("")
