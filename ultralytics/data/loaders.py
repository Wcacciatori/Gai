...
class LoadStreams:
    def __init__(self, sources='file.streams', imgsz=640, vid_stride=1, buffer=False,stop_threads=False):
        ...
        self.mode = 'stream'
        self.imgsz = imgsz
        self.vid_stride = vid_stride  # video frame-rate stride8
    ...
    def update(self, i, cap, stream):
        ...
        while self.running and cap.isOpened() and n < (f - 1) and not self.stop_threads:
